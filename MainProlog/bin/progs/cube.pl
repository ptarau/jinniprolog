...
set_cube(q(P1,P2,_P3),P) :- rotate(P1,P2,P).
set_cube(q(P1,P2,_P3),P) :- rotate(P2,P1,P).
set_cube(q(P1,_P2,P3),P) :- rotate(P1,P3,P).
set_cube(q(P1,_P2,P3),P) :- rotate(P3,P1,P).
set_cube(q(_P1,P2,P3),P) :- rotate(P2,P3,P).
set_cube(q(_P1,P2,P3),P) :- rotate(P3,P2,P).
