...
test(time-A) :- 
        ...
        chat_parser,
        %statistics(cputime,T2),A is (T2-T1)
...
% string/1:
ex_string([what,rivers,are,there,'?']).
ex_string([does,afghanistan,border,china,'?']).
ex_string([what,is,the,capital,of,upper_volta,'?']).
ex_string([where,is,the,largest,country,'?']).
ex_string([which,country,quote,s,capital,is,london,'?']).
ex_string([which,countries,are,european,'?']).
ex_string([how,large,is,the,smallest,american,country,'?']).
ex_string([what,is,the,ocean,that,borders,african,countries,and,that,borders,asian,countries,'?']).
ex_string([what,are,the,capitals,of,the,countries,bordering,the,baltic,'?']).
ex_string([which,countries,are,bordered,by,two,seas,'?']).
ex_string([how,many,countries,does,the,danube,flow,through,'?']).
ex_string([what,is,the,total,area,of,countries,south,of,the,equator,and,not,in,australasia,'?']).
ex_string([what,is,the,average,area,of,the,countries,in,each,continent,'?']).
ex_string([is,there,more,than,one,country,in,each,continent,'?']).
ex_string([is,there,some,ocean,that,does,not,border,any,country,'?']).
ex_string([what,are,the,countries,from,which,a,river,flows,into,the,black_sea,'?']).
