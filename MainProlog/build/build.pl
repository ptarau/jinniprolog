...
makedoc:-
  ...
  cmd(UPDIR,['javadoc -public -use -author -d ',
      ...
      ' -header "<a href=http://www.binnetcorp.com/Jinni>Jinni Prolog in Java<a>" ',
      ' -bottom "<a href=http://www.binnetcorp.com>Get Twin Prolog: the best of a Java and C based Prolog, all in one, from BinNet<a>" ',
      ' -footer "<a href=http://www.binnetcorp.com>Other Prolog and Java Software from BinNet<a>" ',
      JAVASRC,
      ' ',
      JAVASRC1,
      ' ',
