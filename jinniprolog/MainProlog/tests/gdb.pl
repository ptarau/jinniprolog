...
gtest:-
  ...
  gassert(G,D,m,c(1)),
  gassert(G,D,m,c(2)),
  gassert(G,D,c(99),c(3)),
  gassert(G,D,c(_),c(4)),
  gassert(G,D,a(f(_),a,X,X),c(5)),
  gassert(G,D,b(g(k),a,X,f(X)),c(6)),
  gassert(G,D,b(f(n),X,X,g(X)),c(7)),
  gassert(G,D,b(f(m),b,f(X),g(X)),c(8)),
